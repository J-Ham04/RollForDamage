...
{
    const string privateCode = "6h70jpeJ6EW49_Sjjed65wI1rk5fCkoEGLw59tPMd5Fg";  //Key to Upload New Info
    const string publicCode = "62d30cef8f40bb84ec72ee79";   //Key to download
